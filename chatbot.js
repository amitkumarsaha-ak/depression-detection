document.addEventListener("DOMContentLoaded", () => {
    ...
    window.sendMessage = function () {
        ...
        if (window.lastPrediction === 1) {
            ...
            else if (text.includes("tired") || text.includes("exhausted")) {document.addEventListener("DOMContentLoaded", () => {
    ...
    chatbotBtn.addEventListener("click", () => {
        ...
        // 👉 First message (only if empty & not depressed auto mode)
        if (!chatbotPopup.classList.contains("hidden") && chatBox.innerHTML === "") {

            if (window.lastPrediction === 1) {
                appendMessage(chatBox, "I'm here for you 💙", "bot");
            } else {
                appendMessage(chatBox, "Hi! I'm here to help you 💙", "bot");
            }
        }
    ...
    closeBtn.addEventListener("click", () => {
        ...
        // ✅ RESET গুরুত্বপূর্ণ
        window.chatbotOpenedOnce = false;
    });
    ...
    window.appendAutoBotMessage = function (message) {
        ...
        if (window.chatbotOpenedOnce) return;
